...
// source: /Users/unstabler/github/babel-plugin-closure-templates/packages/babel-cli-test/inputs/input1.soy
...
soy.examples.simple.helloNames$ = function ($$areYouAnInternalCaller, $ijData, p$names) {
  ...
  if (names.length != 0) {
    ...
    for (let name20Index = 0; name20Index < name20ListLen; name20Index++) {
      ...
      $output += soy.examples.simple.helloName$(soy.$$internalCallMarkerDoNotUse, $ijData, name20Data) + (name20Index != names.length - 1 ? '<br' + (goog.DEBUG && soy.$$getDebugSoyTemplateInfo() ? ' data-debug-soy="soy.examples.simple.helloNames /Users/unstabler/github/babel-plugin-closure-templates/packages/babel-cli-test/inputs/input1.soy:28"' : '') + '>' : '');
    }
  } else {
